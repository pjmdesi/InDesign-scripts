...
// Set to 1 or true to debug, set back to 0 or fasle to stop debugging
var debug = 0;
        ...
        // go for it!
            ...
            for(var myRowCounter = 0; myRowCounter < myRows; myRowCounter++){
                for(var myColCounter = myRowCounter+1; myColCounter < myColumns; myColCounter++){
                    ...
                    myTable.cells.item(myCellA).paragraphs.item(0).pointSize = myTable.cells.item(myCellB).paragraphs.item(0).pointSize || 12;
...
// If debugging, don't wrap script in single undo action
debug?main():app.doScript(main,ScriptLanguage.JAVASCRIPT,[],UndoModes.ENTIRE_SCRIPT,'main');